...
public class JwtTokenService {
    ...
    public String generateAccessToken(CustomUserDetails userDetails){
        return generateToken(userDetails, EXPIRES_GENERATE);
    }
    public String refreshToken(CustomUserDetails userDetails){
        return generateToken(userDetails, EXPIRES_REFRESH);
    }
    private String generateToken(CustomUserDetails userDetails, Long EXPIRES) {
        return JWT.create()
                .withIssuer(ISSUER)
